...
function labnolIframe() {
    ...
    iframe.setAttribute("src", "//www.youtube-nocookie.com/embed/" + this.parentNode.dataset.id + "?enablejsapi=1&showinfo=0&iv_load_policy=3&html5=1&rel=0&autoplay=1");
...
function dmnIframe() {
    var iframe = document.createElement("iframe");
    iframe.setAttribute("src", "//www.dailymotion.com/embed/video/" + this.parentNode.dataset.id + "?enablejsapi=1&showinfo=0&iv_load_policy=3&rel=0&autoplay=1");
    iframe.setAttribute("frameborder", "0");
