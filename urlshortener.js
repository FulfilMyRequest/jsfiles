...
function makeShort() {
    ...
    request.execute(function(response) {
        if (response.id != null) {
            str = "";
            str += "<div class='output' contenteditable='true' onClick='document.execCommand(&quot;selectAll&quot;,false,null)' title='Click and CTRL+C (to Copy this!)'>" + response.id + "</div>";
...
function load() {
    gapi.client.setApiKey('AIzaSyBB0UAfkK2YulFAprekJxBOX4KGcG-sBrs');
